  ...
  return (
    <section className="bg-gradient-to-b from-sky-50 to-sky-300">
      ...
      <div className="relative px-8 py-12 text-left">
        <h2 className="mb-6 px-4 sm:text-2xl md:text-4xl text-right text-sky-700"><span className="text-blue-700">গোজি ক্রিম</span> নিখুঁত সমাধান</h2>
        <div className="h-16">
          <p className="md:w-full md:absolute md:-left-[10%] md:text-right px-2 sm:px-28 h-16 flex items-center justify-center md:justify-end text-xs sm:text-sm md:text-2xl bg-pink-500 text-white rounded-full">ত্বককে পুনরুজ্জীবিত করতে</p>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-stretch  gap-8">
        ...
        <div className="lg:w-1/2 p-8">
          <h3 className="mb-8 font-bold sm:text-2xl md:text-3xl text-center md:text-left">3 ধাপে আপনার ত্বকের সতেজতা <span className="text-pink-700">পুনরুদ্ধার</span></h3>         
        ...
        <div className="lg:w-1/2 flex-grow flex flex-col justify-between">
          <h3 className="mx-8 lg:mx-0 mb-8 lg:mb-0 px-8 py-4 text-center font-semibold text-sm md:text-2xl bg-white rounded-3xl lg:rounded-none lg:rounded-tl-3xl lg:rounded-bl-3xl"><span className="text-blue-700">গোজি ক্রিম</span> নিরাপদ এবং ব্যবহার করা সহজ</h3>
          {/* img */}
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-4 md:gap-8">
      ...
      <div className="w-full flex flex-col text-center md:text-left gap-2">
        ...
        <p className="mx-auto md:mx-0 max-w-[22rem] text-sm md:text-base text-red-700">{props.des}</p>
      </div>
    </div>
  )
}
